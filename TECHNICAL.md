...
Deep detail for reviewers and engineers. **[← Back to the README](README.md)** for the
plain-English overview.

> Every headline number here was measured on the seeded dataset and is displayed live
> in the product. Where something is simulated — the Parichay SSO screen, blockchain
> anchoring — it is labelled as simulated in the UI, in the API response, and here.
